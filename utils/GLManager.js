...
import { fragment, vertex } from "../shaders/homeShaders";
...
GLManager.prototype.updateTexture = function (newIndex, progress) {
	...
	if (newIndex != null && this.newIndex !== this.currentIndex) {
		...
		this.mesh.material.uniforms.u_texture.value =
			this.textures[this.currentIndex];
		this.mesh.material.uniforms.u_textureFactor.value =
			this.factors[this.currentIndex];
